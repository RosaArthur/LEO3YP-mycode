...
def compilevt(a, s_avg, Ndoors, capacity, N_cars, W, m, w, tstep):
    ...
    from velocity300322 import v_profile
    ##do for each distance vsplit and then compile into one big v, for use in force
    
    [v_0, t_0, d_0, a_i0]= v_profile(a,t_station, s_avg, tstep, d[0])# instantenous acceleration is split wise
    ...
    [v_1, t_1, d_1, a_i1]= v_profile(a,t_station, s_avg, tstep, d[1])
    [v_2, t_2, d_2, a_i2] = v_profile(a,t_station, s_avg, tstep, d[2])
    [v_3, t_3, d_3, a_i3] = v_profile(a,t_station, s_avg, tstep, d[3])
    ...
    a_i=np.array([*a_i0, *a_i1, *a_i2, *a_i3])
    ...
    return v, t, cd_0, cd, d, a_i, t_station